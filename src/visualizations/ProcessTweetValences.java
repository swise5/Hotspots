...
public class ProcessTweetValences extends SimState {

	String dataDir = "/Users/swise/Projects/GISAgents/wildfires/partitionedPeak"; // #WILDFIRE
	String fileType = ".tsv";
	...
	public ProcessTweetValences(long seed) {
		super(seed);
...
//			w.close();
	...
	public static void main(String[] args) {
		doLoop(ProcessTweetValences.class, args);
		System.exit(0);
	}
